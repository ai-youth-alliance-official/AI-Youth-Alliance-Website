...
<main class="join-content">
    ...
    <section class="join-intro">
        ...
        <ul>
            ...
            <li>📜 <strong>Earn a certificate:</strong> Receive a certificate recognizing your contributions, achievements, and involvement in AI Youth Alliance projects.</li>
            <li>📝 <strong>Recommendation letters:</strong> Outstanding members will be eligible for personalized recommendation letters to boost their academic or professional pursuits.</li>
        </ul>
    ...
    <section class="join-intro">
        ...
        <p><strong>⏳ Duration:</strong> minimum 3 months commitment.</p>
